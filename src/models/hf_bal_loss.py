...
# weights = {12: 9.002213788741303,
#  11: 12.626559467701691,
#  13: 53.4428537901901,
#  4: 69.8741945382019,
#  9: 4.532643312101911,
#  7: 103.88686131386861,
#  1: 20.211236353954025,
#  6: 10.098895738170206,
#  8: 15.897793912314997,
#  10: 10.424830617103096,
#  5: 22.660961289680564,
#  3: 6.104930162730221,
#  2: 32.059693087427846}
...
class Bigbird_multitask(LightningModule):
    ...
    def __init__(
        ...
        self.weight_index = self.hparams.weight_index

        self.weights = [0.5 for i in range(13)]
        self.weights[self.weight_index-1] = 1
